---
title: "高中生物中出现的各种试剂"
date: 2022-01-22T23:08:41+08:00
draft: false
markup:
math: false
categories:
...
2. 用肉眼观察。
    或者：
1. 在切片上滴加 2~3 滴苏丹 Ⅲ染液，染色 3 分钟。（或用苏丹 Ⅳ 染液染色 1 分钟）
2. 用吸水纸吸去染液，再滴加 1~2 滴体积分数为 50% 的酒精溶液，洗去浮色。
3. 用吸水纸洗去酒精，滴加一滴蒸馏水，制成临时装片。
4. 在显微镜（先低倍后高倍）下观察。
...
- 0.14 mol/L 的 NaCl 溶液中，DNA析出（溶解度低），蛋白质溶解（溶解度高）。
- 低浓度或高浓度的 NaCl 溶液中，DNA溶解（溶解度高），蛋白质析出（溶解度低）。
